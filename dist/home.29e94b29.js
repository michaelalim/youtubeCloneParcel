...
module.exports = "/channel.a932ec01.PNG";
...
},{}],"home/index.js":[function(require,module,exports) {
"use strict";

var _videos = require("../../dependencies/arrays/videos.js");

var _sidebar = require("../../dependencies/elements/sidebar.js");

var _categories = require("../../dependencies/arrays/categories.js");

// videosArray
//sidebar
//categoriesArr
(0, _sidebar.startUp)("Home");
var videosEl = document.querySelectorAll("div.video-el");
var contentContainer = document.getElementById("video-content");
var categoryContainer = document.getElementById("categories-container");
videoDisplay(_videos.videoList); //I put it here cause the video title only appears after here from the call of the videoDisplay function

var videoTitleEl = document.querySelectorAll(".video-title"); //clicking the video

videosEl.forEach(function (div) {
  div.addEventListener("click", function () {
    location.href = "#";
  });
});
videoTitleEl.forEach(function (div) {
  div.addEventListener("click", function () {
    location.href = "#";
  });
});
...
_categories.categories.forEach(function (cat) {
  ...
  if (count === 0) {
    ...
    btn.setAttribute("id", "category".concat(count + 1));
  }
...
var categoryBtn = document.querySelectorAll("button.category"); //clicking the search !! this should hide other header elements and show input element
...
function videoDisplay(arr) {
  arr.forEach(function (vids) {
    ...
    var viewsCount = document.createElement("h6");
    viewsCount.classList.add("views-count");
    viewsCount.textContent = "".concat(vids.views, " views \xB7 ").concat(vids.age, " ago");
    textDiv.appendChild(viewsCount);
  });
}
},{"../../dependencies/arrays/videos.js":"../dependencies/arrays/videos.js","../../dependencies/elements/sidebar.js":"../dependencies/elements/sidebar.js","../../dependencies/arrays/categories.js":"../dependencies/arrays/categories.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/home.29e94b29.js.map